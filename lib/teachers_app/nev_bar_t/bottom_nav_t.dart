...
import 'notice_page_t.dart';
import 'profile_page_t.dart';
import '../teacher_home.dart';

class BottomNavT extends StatelessWidget {
  final int currentIndex;

  const BottomNavT({super.key, required this.currentIndex});
  ...
  void _navigateTo(BuildContext context, int index) {
    ...
    switch (index) {
      case 0:
        ...
        break;
      case 1:
        destination = const NoticePageT();
        break;
      case 2:
        destination = const ProfilePageT();
        break;
      default:
        return;
    }
      ...
      child: ClipRRect(
        ...
        child: Material(
          ...
          child: BottomNavigationBar(
            ...
            elevation: 0,
            selectedItemColor: Colors.white, // ✅ সিলেক্ট আইটেম কালার সাদা
